...
class BlogCommentsControllerTest < ActionController::TestCase
  ...
  test "should create blog_comment" do
    assert_difference('BlogComment.count') do
      post :create, blog_comment: { blogger_id: @blog_comment.blogger_id, post: @blog_comment.post, title: @blog_comment.title }
    end
  ...
  test "should update blog_comment" do
    patch :update, id: @blog_comment, blog_comment: { blogger_id: @blog_comment.blogger_id, post: @blog_comment.post, title: @blog_comment.title }
    assert_redirected_to blog_comment_path(assigns(:blog_comment))
  end
